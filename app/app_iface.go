...
type AppIface interface {
	...
	GetPostsForChannelAroundLastUnread(c request.CTX, channelID, userID string, limitBefore, limitAfter int, skipFetchThreads bool, collapsedThreads, collapsedThreadsExtended bool, sortType string, since int64) (*model.PostList, *model.AppError)
